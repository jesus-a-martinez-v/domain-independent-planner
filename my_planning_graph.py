...
class PlanningGraph:
    ...
    def add_action_level(self, level):
        ...
        for action in self.all_actions:
            ...
            if a_node.prenodes.issubset(previous_level):
                for s_node in previous_level:
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        first_node_action = node_a1.action
        second_node_action = node_a2.action

        first_action_effects_negated_by_the_second = set(first_node_action.effect_add).intersection(
            second_node_action.effect_rem)
        second_actions_effects_negated_by_the_first = set(second_node_action.effect_add).intersection(
            first_node_action.effect_rem)

        return len(first_action_effects_negated_by_the_second) != 0 or len(second_actions_effects_negated_by_the_first) != 0
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        first_action_precond_negated_by_the_second = set(first_node_action.precond_neg).intersection(
            second_node_action.effect_add).union(set(first_node_action.precond_pos).intersection(second_node_action.effect_rem))
        second_actions_precond_negated_by_the_first = set(second_node_action.precond_neg).intersection(
            first_node_action.effect_add).union(set(second_node_action.precond_pos).intersection(first_node_action.effect_rem))

        return len(first_action_precond_negated_by_the_second) != 0 or len(second_actions_precond_negated_by_the_first) != 0
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        return node_s2.symbol == node_s1.symbol and node_s1.is_pos != node_s2.is_pos
